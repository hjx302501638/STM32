...
const unsigned char Char_versionNum[4][10]    =   {
                                                  "WTcnA_V1.5",
                                                  "WTcnB_V1.5",
																									"WTcnC_V1.5",
																									"WTcnD_V1.5",
...
const unsigned char Char_QuickDisplay1 [4][16]={"    快捷取水    ",
                                               "上: RO    下: UP",
                                               "                ",
                                               "按确认键进入系统",
                                               };
const unsigned char Char_HighSet[20][12]   =   {"控制点检测",
                                               "水质采样  ",
                                               "语音检测  ",
                                               "RO流量设置",																							 
                                               "UP流量设置",
...
const unsigned char Char_HighSet_Conductance_ED[15]  =   {"EDI 电阻率系数:"};
...
const unsigned char Char_GetWater[6][12]  =   {"取RO水    ",
                                               "取UP水    ",																					
                                               "定量取RO水",
                                               "定量取UP水",
																								"取EDI 水  ",
...
const unsigned char Char_GetEDI[14]                  =   {"正在取EDI 水.."}; 
